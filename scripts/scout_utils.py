...
COLD_SEED_IDS = [
    # Surfaced from Kuhn C2 warm zone — entropy/hydrology paper
    # In lag state for Scout 1 (references not indexed yet)
    # Scout 2 (forward/citations) should still work — 2 incoming citations exist
    {
        "label": "When physics gets in the way: entropy-based evaluation (2026) — lag state",
